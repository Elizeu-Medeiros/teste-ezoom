...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="<?php echo base_img('icon/favicon.ico'); ?>?v=1">
    ...
    })(window,document,'script','dataLayer','<?php echo $company->google_tag_manager; ?>');</script>
...
<body>
    <div id="wrapper">
    <?php echo $header, $breadcrumb, $content, $footer; ?>
    </div>
