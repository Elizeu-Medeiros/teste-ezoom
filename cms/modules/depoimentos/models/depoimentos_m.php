...
{
    public $table = 'site_testimonial';
    public $table_description = 'site_testimonial_description';
    public $table_unit = 'site_testimonial_unit';
    public $primary_key = 'id';
    public $foreign_key = 'id_testimonial';
