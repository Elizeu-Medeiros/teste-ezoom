                            ...
                            <?php foreach($languages as $key => $language){ ?>
                                <div class="tab-pane<?php echo ($key == 0) ? ' active in ' : ''; ?> fade" id="tablang<?php echo $key; ?>">
                                    <div class="col-xs-12 form-group">
                                        ...
                                        <input type="text" class="form-control" name="value[<?php echo $language->id; ?>][title]" id="inputTitle<?php echo $key; ?>" placeholder="Título" value="<?php echo (isset($item->languages[$language->id])) ? $item->languages[$language->id]->title : ''; ?>"<?php echo ($language->id == 1) ? ' required' : '';?>>
                                    </div>
                                    <div class="col-xs-12 col-md-12 col-sm-12 form-group">
                                        <label for="inputText<?php echo $key; ?>" class="control-label"><?php echo T_('Texto'); ?>: </label>
