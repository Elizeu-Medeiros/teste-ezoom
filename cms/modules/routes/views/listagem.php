            ...
            <tbody id="sortable">
                ...
                <tr data-id="<?php echo $item->id; ?>" id="item-<?php echo $item->id; ?>" >
                    ...
                    <td class="text-right nowrap">
                        ...
                        <?php } if ($this->auth->data('admin') == 1 && in_array('copiar', $session_permissions[$current_module->id])){ ?>
                        ...
                        <a href="<?php echo site_url($current_module->slug . '/editar/'.$item->id); ?>"> <button class="btn btn-default"><i class="fa fa-edit"></i> <?php echo T_('Editar'); ?></button></a>
                        <?php } if (in_array('excluir', $session_permissions[$current_module->id])) { ?>
                        <a href="<?php echo site_url($current_module->slug . '/delete/'.$item->id); ?>" class="delete-button"> <button class="btn btn-default"><i class="fa fa-trash-alt"></i> <?php echo T_('Excluir'); ?></button></a>
                        <?php } ?>
                    </td>
                </tr>
                <?php } ?>
