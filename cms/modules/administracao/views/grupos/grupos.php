            ...
            <tbody>
                <?php foreach ($groups as $key => $group){ ?>
                    <tr data-id="<?php echo $group->id; ?>">
                        ...
                        <td class="text-right">
                            <?php if (in_array('editar', $session_permissions[$current_module->id])){ ?>
                            <a href="<?php echo site_url('administracao/grupos/editar/'.$group->id); ?>"><button class="btn btn-default"><i class="fa fa-edit"></i> <?php echo T_('Editar'); ?></button></a>
                            <?php }
                            if (in_array('excluir', $session_permissions[$current_module->id])){ ?>
                            <a href="<?php echo site_url('administracao/grupos/delete/'.$group->id); ?>" class="delete-button"><button class="btn btn-default"><i class="fa fa-trash-alt"></i> <?php echo T_('Excluir'); ?></button></a>
                            <?php } ?>
                        </td>
                    </tr>
                <?php } ?>
