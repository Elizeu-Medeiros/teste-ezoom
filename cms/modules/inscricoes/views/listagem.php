                ...
                <tr>
                    ...
                    <th>
                        <a href="<?php echo order_url('name'); ?>">
                            <?php echo T_('Nome').' '.order_ico('name', $order_by); ?>
                        </a>
                    </th>
                    <th>
                    ...
                    <th>
                        <?php echo T_('Unidade').' '.order_ico('unit', $order_by); ?>
                    </th>
                    <th>
            ...
            <tbody>
                ...
                foreach ($items as $key => $item) {
                    ...
                    <tr data-id="<?php echo $item->id; ?>" id="item-<?php echo $item->id; ?>" >
                        ...
                        <td class="text-middle"><?php echo $item->unit; ?></td>
                        ...
                        <td class="text-right action-column">
                            ...
                            <?php if (in_array('excluir', $session_permissions[$current_module->id])) { ?>
                            <a title="Excluir" href="<?php echo site_url($current_module->slug . '/delete/'.$item->id); ?>" class="delete-button"><button class="btn btn-default"><i class="fa fa-trash-alt"></i></button></a>
                            <?php } ?>
                        </td>
                    </tr>
                    <?php
