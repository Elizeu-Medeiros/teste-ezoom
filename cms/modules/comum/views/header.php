<header class="hidden-print">
    <div id="menu-logo" class="hidden-xs">
        <a href="<?php echo site_url(); ?>" class="display-block-inline logo"><img src="<?php echo base_img('logo.png'); ?>" alt="Ezoom CMS"></a>
    </div>
    ...
    <!-- <div class="menu-action menu-action-language pull-left">
        <span title="<?php echo T_('Idioma'); ?>" target="_blank" class="btn btn-primary"><?php echo T_('IDIOMA'); ?> - <?php echo strtoupper($lang); ?></span>
        <ul class="hide">
            <?php foreach ($languages as $key => $value) { ?>
            <li>
                <?php if($lang != $value->code){ ?>
                <a href="<?php echo site_url($value->code.'/'.(isset($current_module->slug) ? $current_module->slug : '')); ?>"><?php echo $value->name; ?></a>
                <?php } else { ?>
    ...
    <div id="menu-config" class="pull-right" data-toggle="menu-config-dropdown">
        <span class="pull-left">
            ...
            <span class="hidden-xs"><?php echo $this->auth->data('name'); ?></span> <span class="caret"></span>
        </span>
