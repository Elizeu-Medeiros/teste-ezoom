...
(function (window) {
    ...
    Comum.prototype.initMasks = function () {
        ...
        $('input[type="phone"]').inputmask("mask", {"mask": "(99) 9999-9999[9]" });
        $('input[name*="zipcode"]').inputmask("mask", {"mask": "99999-999" });
        $('input[type="cnpj"]').inputmask("mask", {"mask": "99.999.999/9999-99" });
    }
