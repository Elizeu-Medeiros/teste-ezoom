 ...
 * @category Model
 */
class Niveis_de_ensino_m extends MY_Model
{
    public $table = 'site_teaching_level';
    public $table_description = 'site_teaching_level_description';
    public $table_unit = 'site_teaching_level_unit';
    public $primary_key = 'id';
    public $foreign_key = 'id_teaching_level';
    ...
    public function update($id, $data)
    {
        ...
        $this->db->where($this->foreign_key, $id)->delete($this->table_unit);
        if(isset($data["unit"]))
            foreach($data["unit"] as $id_unit){
                $this->db->insert($this->table_unit, array(
                    $this->foreign_key  => $id,
    ...
    private function _get_units($id, $id_language = FALSE)
    {
        $this->db
            ...
            ->where($this->table_unit.'.'.$this->foreign_key, $id);
        if ($id_language)
